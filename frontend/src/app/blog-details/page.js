                ...
                <div className="auto-container">
                    ...
                    <div className="col-lg-4 col-md-12 col-sm-12 sidebar-side">
                        ...
                        <div className="sidebar-widget post-widget">
                                ...
                                <div className="widget-content post-inner">
                                    <div className="post">
                                        <figure className="post-thumb"><Link href="blog-details"><img src="https://www.heart.org/-/media/Images/News/2018/December-2018/1213Eyes_SC.jpg?h=601&w=800&sc_lang=en&hash=C6E6D9085583F2D4AE18C685F5CE3E97" alt="" /></Link></figure>
                        ...
                        <div className="sidebar-widget gallery-widget">
                                ...
                                <div className="widget-content">
                                    <ul className="image-list clearfix">
                                        <li>
                                            <figure className="image"><Link href="assets/images/news/gallery-1.jpg" className="lightbox-image" data-fancybox="gallery"><img src="https://d2jx2rerrg6sh3.cloudfront.net/image-handler/picture/2020/10/shutterstock_284175866.jpg" alt="" /></Link></figure>
                                        </li>
                                        <li>
                                            <figure className="image"><Link href="assets/images/news/gallery-2.jpg" className="lightbox-image" data-fancybox="gallery"><img src="https://d2jx2rerrg6sh3.cloudfront.net/image-handler/picture/2020/10/shutterstock_284175866.jpg" alt="" /></Link></figure>
                                        </li>
                                        <li>
                                            <figure className="image"><Link href="assets/images/news/gallery-3.jpg" className="lightbox-image" data-fancybox="gallery"><img src="https://d2jx2rerrg6sh3.cloudfront.net/image-handler/picture/2020/10/shutterstock_284175866.jpg" alt="" /></Link></figure>
                                        </li>
                                        <li>
                                            <figure className="image"><Link href="assets/images/news/gallery-4.jpg" className="lightbox-image" data-fancybox="gallery"><img src="https://d2jx2rerrg6sh3.cloudfront.net/image-handler/picture/2020/10/shutterstock_284175866.jpg" alt="" /></Link></figure>
                                        </li>
                                        <li>
                                            <figure className="image"><Link href="assets/images/news/gallery-5.jpg" className="lightbox-image" data-fancybox="gallery"><img src="https://d2jx2rerrg6sh3.cloudfront.net/image-handler/picture/2020/10/shutterstock_284175866.jpg" alt="" /></Link></figure>
                                        </li>
                                        <li>
                                            <figure className="image"><Link href="assets/images/news/gallery-6.jpg" className="lightbox-image" data-fancybox="gallery"><img src="https://d2jx2rerrg6sh3.cloudfront.net/image-handler/picture/2020/10/shutterstock_284175866.jpg" alt="" /></Link></figure>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div className="col-lg-8 col-md-12 col-sm-12 content-side">
                        ...
                        <div className="news-block-one">
                            ...
                            <figure className="image-box"><img src="https://www.retinamn.com/media/pages/blog/genetic-inherited-retinal-diseases/374020cfcb-1651492180/istock-665174414-3.jpg" alt="" /></figure>
                                        ...
                                        <div className="two-image">
                                            <div className="row clearfix">
                                                <div className="col-lg-6 col-md-6 col-sm-12 image-column">
                                                    <figure className="image mb_30"><img src="https://retinaaustralia.com.au/wp-content/uploads/2022/11/Autosomal-recessive-inheritance.png" alt="" /></figure>
                                                </div>
                                                <div className="col-lg-6 col-md-6 col-sm-12 image-column">
                                                    <figure className="image mb_30"><img src="https://figures.semanticscholar.org/978dcb364743db7323be3225aa00f7c6ec2063eb/4-Figure2-1.png" alt="" /></figure>
                                                </div>
                                            </div>
                                        </div>
                                        <p>Nullam elit elit, vehicula sit amet lobortis quis, luctus vitae purus. Etiam vitae leo non magna venenatis congue. Ut commodo, tellus id gravida ultricies, libero mauris aliquam enim, in luctus nunc nisi eu neque. Aenean lacinia, tortor ac sagittis venenatis, massa velit fringilla tortor, a venenatis mi sapien. Maecenas a tellus at justo molestie pulvinar</p>
